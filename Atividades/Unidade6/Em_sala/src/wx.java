...
public class wx {
    ...
    public static void excluirItemEspaconave(Scanner scanner, String[] valores, int[] pesos, String valorEx, int itemCont, int capacidade) {
        if (itemCont == 0) {
            System.out.println("A espaçonave está vazia.");
        }
        ...
        do {
            ...
            switch (opc) {
                ...
                case 5:
                    ...
                    excluirItemEspaconave(scanner, valores, pesos, valorEx, itemCont, capacidade);
                    if (itemCont > 0) {
                        itemCont--;
                    }
                    break;
